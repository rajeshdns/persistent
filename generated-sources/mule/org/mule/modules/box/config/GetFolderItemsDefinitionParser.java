...
import org.mule.modules.box.processors.GetFolderItemsMessageProcessor;
...
public class GetFolderItemsDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetFolderItemsMessageProcessor.class.getName());
        builder.addConstructorArgValue("getFolderItems");
