...
import org.mule.modules.box.processors.GetEventsMessageProcessor;
    ...
    extends AbstractDevkitBasedDefinitionParser
{
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        parseProperty(builder, element, "streamPosition", "streamPosition");
        parseProperty(builder, element, "streamType", "streamType");
