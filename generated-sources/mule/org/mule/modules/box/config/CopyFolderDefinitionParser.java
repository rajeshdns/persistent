...
import org.mule.modules.box.processors.CopyFolderMessageProcessor;
...
public class CopyFolderDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CopyFolderMessageProcessor.class.getName());
        builder.addConstructorArgValue("copyFolder");
