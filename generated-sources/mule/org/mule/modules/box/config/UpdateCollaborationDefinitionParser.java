...
public class UpdateCollaborationDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(UpdateCollaborationMessageProcessor.class.getName());
        builder.addConstructorArgValue("updateCollaboration");
