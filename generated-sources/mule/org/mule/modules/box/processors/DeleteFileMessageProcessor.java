...
/**
 * DeleteFileMessageProcessor invokes the {@link org.mule.modules.box.BoxConnector#deleteFile(java.lang.String, java.lang.String)} method in {@link BoxConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedFileId = ((String) evaluateAndTransform(getMuleContext(), event, DeleteFileMessageProcessor.class.getDeclaredField("_fileIdType").getGenericType(), null, fileId));
            final String _transformedEtag = ((String) evaluateAndTransform(getMuleContext(), event, DeleteFileMessageProcessor.class.getDeclaredField("_etagType").getGenericType(), null, etag));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((BoxConnector) object).deleteFile(_transformedFileId, _transformedEtag);
                    return null;
                }
