...
/**
 * DownloadMessageProcessor invokes the {@link org.mule.modules.box.BoxConnector#download(java.lang.String, java.lang.String)} method in {@link BoxConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public DownloadMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedFileId = ((String) evaluateAndTransform(getMuleContext(), event, DownloadMessageProcessor.class.getDeclaredField("_fileIdType").getGenericType(), null, fileId));
            final String _transformedVersion = ((String) evaluateAndTransform(getMuleContext(), event, DownloadMessageProcessor.class.getDeclaredField("_versionType").getGenericType(), null, version));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BoxConnector) object).download(_transformedFileId, _transformedVersion);
                }
