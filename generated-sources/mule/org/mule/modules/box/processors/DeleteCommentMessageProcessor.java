...
/**
 * DeleteCommentMessageProcessor invokes the {@link org.mule.modules.box.BoxConnector#deleteComment(java.lang.String)} method in {@link BoxConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((BoxConnector) object).deleteComment(_transformedCommentId);
                    return null;
                }
