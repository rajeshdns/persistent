    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public GetTrashedItemsMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final Long _transformedLimit = ((Long) evaluateAndTransform(getMuleContext(), event, GetTrashedItemsMessageProcessor.class.getDeclaredField("_limitType").getGenericType(), null, limit));
            final Long _transformedOffset = ((Long) evaluateAndTransform(getMuleContext(), event, GetTrashedItemsMessageProcessor.class.getDeclaredField("_offsetType").getGenericType(), null, offset));
            final PagingConfiguration _transformedPagingConfiguration = ((PagingConfiguration) evaluateAndTransform(getMuleContext(), event, GetTrashedItemsMessageProcessor.class.getDeclaredField("_pagingConfigurationType").getGenericType(), null, pagingConfiguration));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BoxConnector) object).getTrashedItems(_transformedLimit, _transformedOffset, _transformedPagingConfiguration);
                }
