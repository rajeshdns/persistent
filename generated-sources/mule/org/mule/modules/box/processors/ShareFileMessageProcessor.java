...
/**
 * ShareFileMessageProcessor invokes the {@link org.mule.modules.box.BoxConnector#shareFile(java.lang.String, org.mule.modules.box.model.SharedLink)} method in {@link BoxConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-cascade", date = "2014-02-03T12:16:48-06:00", comments = "Build UNNAMED.1791.ad9d188")
public class ShareFileMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public ShareFileMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedFileId = ((String) evaluateAndTransform(getMuleContext(), event, ShareFileMessageProcessor.class.getDeclaredField("_fileIdType").getGenericType(), null, fileId));
            final SharedLink _transformedSharedLink = ((SharedLink) evaluateAndTransform(getMuleContext(), event, ShareFileMessageProcessor.class.getDeclaredField("_sharedLinkType").getGenericType(), null, sharedLink));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BoxConnector) object).shareFile(_transformedFileId, _transformedSharedLink);
                }
