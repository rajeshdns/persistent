    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public GetVersionsMetadataMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedFileId = ((String) evaluateAndTransform(getMuleContext(), event, GetVersionsMetadataMessageProcessor.class.getDeclaredField("_fileIdType").getGenericType(), null, fileId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BoxConnector) object).getVersionsMetadata(_transformedFileId);
                }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        return new DefaultResult<MetaData>(new DefaultMetaData(getPojoOrSimpleModel(FileVersionResponse.class)));
    }
