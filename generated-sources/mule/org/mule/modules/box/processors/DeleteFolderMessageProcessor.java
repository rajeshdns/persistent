...
/**
 * DeleteFolderMessageProcessor invokes the {@link org.mule.modules.box.BoxConnector#deleteFolder(java.lang.String, java.lang.Boolean)} method in {@link BoxConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public DeleteFolderMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedFolderId = ((String) evaluateAndTransform(getMuleContext(), event, DeleteFolderMessageProcessor.class.getDeclaredField("_folderIdType").getGenericType(), null, folderId));
            final Boolean _transformedRecursive = ((Boolean) evaluateAndTransform(getMuleContext(), event, DeleteFolderMessageProcessor.class.getDeclaredField("_recursiveType").getGenericType(), null, recursive));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((BoxConnector) object).deleteFolder(_transformedFolderId, _transformedRecursive);
                    return null;
                }
