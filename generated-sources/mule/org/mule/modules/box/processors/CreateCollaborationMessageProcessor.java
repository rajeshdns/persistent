...
/**
 * CreateCollaborationMessageProcessor invokes the {@link org.mule.modules.box.BoxConnector#createCollaboration(org.mule.modules.box.model.Collaboration)} method in {@link BoxConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-cascade", date = "2014-02-03T12:16:48-06:00", comments = "Build UNNAMED.1791.ad9d188")
public class CreateCollaborationMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public CreateCollaborationMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final Collaboration _transformedCollaboration = ((Collaboration) evaluateAndTransform(getMuleContext(), event, CreateCollaborationMessageProcessor.class.getDeclaredField("_collaborationType").getGenericType(), null, collaboration));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BoxConnector) object).createCollaboration(_transformedCollaboration);
                }
