    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public UpdateFileMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedFileId = ((String) evaluateAndTransform(getMuleContext(), event, UpdateFileMessageProcessor.class.getDeclaredField("_fileIdType").getGenericType(), null, fileId));
            final UpdateItemRequest _transformedRequest = ((UpdateItemRequest) evaluateAndTransform(getMuleContext(), event, UpdateFileMessageProcessor.class.getDeclaredField("_requestType").getGenericType(), null, request));
            final String _transformedEtag = ((String) evaluateAndTransform(getMuleContext(), event, UpdateFileMessageProcessor.class.getDeclaredField("_etagType").getGenericType(), null, etag));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BoxConnector) object).updateFile(_transformedFileId, _transformedRequest, _transformedEtag);
                }
