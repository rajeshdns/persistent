    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final Long _transformedLimit = ((Long) evaluateAndTransform(getMuleContext(), event, SearchMessageProcessor.class.getDeclaredField("_limitType").getGenericType(), null, limit));
            final Long _transformedOffset = ((Long) evaluateAndTransform(getMuleContext(), event, SearchMessageProcessor.class.getDeclaredField("_offsetType").getGenericType(), null, offset));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BoxConnector) object).search(_transformedQuery, _transformedLimit, _transformedOffset);
                }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        return new DefaultResult<MetaData>(new DefaultMetaData(getPojoOrSimpleModel(SearchResponse.class)));
    }
