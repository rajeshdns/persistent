...
/**
 * CopyFileMessageProcessor invokes the {@link org.mule.modules.box.BoxConnector#copyFile(java.lang.String, java.lang.String)} method in {@link BoxConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedTargetFolderId = ((String) evaluateAndTransform(getMuleContext(), event, CopyFileMessageProcessor.class.getDeclaredField("_targetFolderIdType").getGenericType(), null, targetFolderId));
            final String _transformedFileId = ((String) evaluateAndTransform(getMuleContext(), event, CopyFileMessageProcessor.class.getDeclaredField("_fileIdType").getGenericType(), null, fileId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BoxConnector) object).copyFile(_transformedTargetFolderId, _transformedFileId);
                }
