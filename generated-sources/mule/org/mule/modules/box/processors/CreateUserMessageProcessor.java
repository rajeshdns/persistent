...
/**
 * CreateUserMessageProcessor invokes the {@link org.mule.modules.box.BoxConnector#createUser(org.mule.modules.box.model.User)} method in {@link BoxConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BoxConnector) object).createUser(_transformedUser);
                }
