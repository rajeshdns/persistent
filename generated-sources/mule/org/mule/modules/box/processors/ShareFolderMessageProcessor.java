...
/**
 * ShareFolderMessageProcessor invokes the {@link org.mule.modules.box.BoxConnector#shareFolder(java.lang.String, org.mule.modules.box.model.SharedLink)} method in {@link BoxConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.5.0-cascade", date = "2014-02-19T08:18:38-06:00", comments = "Build UNNAMED.1791.ad9d188")
public class ShareFolderMessageProcessor
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public ShareFolderMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedFolderId = ((String) evaluateAndTransform(getMuleContext(), event, ShareFolderMessageProcessor.class.getDeclaredField("_folderIdType").getGenericType(), null, folderId));
            final SharedLink _transformedSharedLink = ((SharedLink) evaluateAndTransform(getMuleContext(), event, ShareFolderMessageProcessor.class.getDeclaredField("_sharedLinkType").getGenericType(), null, sharedLink));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((BoxConnector) object).shareFolder(_transformedFolderId, _transformedSharedLink);
                }
    ...
    public Result<MetaData> getInputMetaData() {
        return new DefaultResult<MetaData>(new DefaultMetaData(getPojoOrSimpleModel(SharedLink.class)));
    }
