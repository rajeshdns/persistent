...
public class EntityExpressionHolderTransformer
    ...
    implements DiscoverableTransformer, MessageTransformer
{
    ...
    public boolean isSourceTypeSupported(Class<?> aClass) {
        return (aClass == EntityExpressionHolder.class);
    }

    public boolean isSourceDataTypeSupported(DataType<?> dataType) {
        return (dataType.getType() == EntityExpressionHolder.class);
    }

    public List<Class<?>> getSourceTypes() {
        return Arrays.asList(new Class<?> [] {EntityExpressionHolder.class });
    }

    public List<DataType<?>> getSourceDataTypes() {
        return Arrays.asList(new DataType<?> [] {DataTypeFactory.create(EntityExpressionHolder.class)});
    }
    ...
    public DataType<?> getReturnDataType() {
        return DataTypeFactory.create(Entity.class);
    }
        ...
        throws TransformerMessagingException
    {
        ...
        EntityExpressionHolder holder = ((EntityExpressionHolder) src);
