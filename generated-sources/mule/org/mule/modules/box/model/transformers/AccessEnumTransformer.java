...
public class AccessEnumTransformer
    ...
    implements DiscoverableTransformer
{
    ...
    public AccessEnumTransformer() {
        registerSourceType(DataTypeFactory.create(String.class));
        setReturnClass(Access.class);
        setName("AccessEnumTransformer");
    }
    ...
    {
        Access result = null;
        result = Enum.valueOf(Access.class, ((String) src));
        return result;
    }
